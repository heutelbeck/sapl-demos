...
class PatientForm extends AbstractPatientForm {
	...
	protected void updateFieldVisibility() {
		...
		final MultiRequest multiRequest = new MultiRequest()
				.addRequest("readMrn", authentication, "read",
						medicalRecordNumber.getData())
				.addRequest("readName", authentication, "read", name.getData())
				.addRequest("readDiagnosis", authentication, "read",
						diagnosisText.getData())
				.addRequest("readIcd11", authentication, "read", icd11Code.getData())
				.addRequest("readAttendingDoctor", authentication, "read",
						attendingDoctor.getData())
				.addRequest("readAttendingNurse", authentication, "read",
						attendingNurse.getData())
				.addRequest("readPhoneNumber", authentication, "read",
						phoneNumber.getData());
		try {
		...
		diagnosisText.setVisible(
				multiResponse.isAccessPermittedForRequestWithId("readDiagnosis"));
		icd11Code
				.setVisible(multiResponse.isAccessPermittedForRequestWithId("readIcd11"));
		attendingDoctor.setVisible(
				multiResponse.isAccessPermittedForRequestWithId("readAttendingDoctor"));
		attendingNurse.setVisible(
				multiResponse.isAccessPermittedForRequestWithId("readAttendingNurse"));
		phoneNumber.setVisible(
				multiResponse.isAccessPermittedForRequestWithId("readPhoneNumber"));
		roomNumber.setVisible(
				multiResponse.isAccessPermittedForRequestWithId("readRoomNumber"));
	}

	protected void updateFieldEnabling() {
		final Authentication authentication = SecurityUtils.getAuthentication();
		final MultiRequest multiRequest = new MultiRequest()
				.addRequest("editMrn", authentication, "edit",
						medicalRecordNumber.getData())
				.addRequest("editName", authentication, "edit", name.getData())
				.addRequest("editDiagnosis", authentication, "edit",
						diagnosisText.getData())
				.addRequest("editIcd11", authentication, "edit", icd11Code.getData())
				.addRequest("editAttendingDoctor", authentication, "edit",
						attendingDoctor.getData())
				.addRequest("editAttendingNurse", authentication, "edit",
						attendingNurse.getData())
				.addRequest("editPhoneNumber", authentication, "edit",
						phoneNumber.getData())
				.addRequest("editRoomNumber", authentication, "edit",
						roomNumber.getData());
		...
		icd11Code
				.setEnabled(multiResponse.isAccessPermittedForRequestWithId("editIcd11"));
		diagnosisText.setEnabled(
				multiResponse.isAccessPermittedForRequestWithId("editDiagnosis"));
		attendingDoctor.setEnabled(
				multiResponse.isAccessPermittedForRequestWithId("editAttendingDoctor"));
		attendingNurse.setEnabled(
				multiResponse.isAccessPermittedForRequestWithId("editAttendingNurse"));
		phoneNumber.setEnabled(
				multiResponse.isAccessPermittedForRequestWithId("editPhoneNumber"));
		roomNumber.setEnabled(
				multiResponse.isAccessPermittedForRequestWithId("editRoomNumber"));
	}
	...
	protected void updateButtonVisibility() {
		...
		final Authentication authentication = SecurityUtils.getAuthentication();
		final MultiRequest multiRequest = new MultiRequest();
		multiRequest.addRequest("useSaveBtn", authentication,
		...
		deleteBtn.setVisible(!isNewPatient
				&& multiResponse.isAccessPermittedForRequestWithId("useDeleteBtn"));
	}
