...
/**
 * defines a custom resolver used in unit tests
 * provides a simple example how to add custom logic to resolve policy definitions
 * see the {@link UnitTestPolicyResolver} interface to learn when this is used.
 */
