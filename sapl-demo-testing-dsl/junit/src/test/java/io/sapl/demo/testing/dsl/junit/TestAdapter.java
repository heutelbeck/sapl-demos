 ...
 * the sapl-test-junit module provides the JUnitTestAdapter as the default way to execute tests defined in the SAPLTest language.
 * the minimum setup requires an empty class body (just extending JUnitTestAdapter) for the Junit Runner of Eclipse, IntelliJ IDEA and Maven Surefire to discover tests
 * By default all files with the .sapltest file extensions located in src/test/resources and all sub-folders are discovered
 */
