...
public class DemoData {
    ...
    public static LibraryUserDetails[] users(PasswordEncoder encoder) {
        ...
        return new LibraryUserDetails[] {
            new LibraryUserDetails(new LibraryUser("boss", 0, List.of(1,2,3,4,5), List.of()), encodedPassword),
            new LibraryUserDetails(new LibraryUser("zoe",  1, List.of(1,2),       List.of()), encodedPassword),
            new LibraryUserDetails(new LibraryUser("bob",  2, List.of(3,4),       List.of()), encodedPassword),
            new LibraryUserDetails(new LibraryUser("ann",  3, List.of(5),         List.of()), encodedPassword),
            new LibraryUserDetails(new LibraryUser("pat",  4, List.of(),          List.of()), encodedPassword),
        };
        // @formatter:on
    }
