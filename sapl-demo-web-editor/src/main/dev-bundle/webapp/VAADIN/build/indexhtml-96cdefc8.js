 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var ut,mt,ht,pt;const I=window,g=o=>{I.emitLitDebugLogEvents&&I.dispatchEvent(new CustomEvent("lit-debug",{detail:o}))};let sn=0,qe;(ut=I.litIssuedWarnings)!==null&&ut!==void 0||(I.litIssuedWarnings=new Set),qe=(o,e)=>{e+=o?` See https://lit.dev/msg/${o} for more information.`:"",I.litIssuedWarnings.has(e)||(console.warn(e),I.litIssuedWarnings.add(e))},qe("dev-mode","Lit is in dev mode. Not recommended for production!");const P=!((mt=I.ShadyDOM)===null||mt===void 0)&&mt.inUse&&((ht=I.ShadyDOM)===null||ht===void 0?void 0:ht.noPatch)===!0?I.ShadyDOM.wrap:o=>o,de=I.trustedTypes,fo=de?de.createPolicy("lit-html",{createHTML:o=>o}):void 0,an=o=>o,Je=(o,e,t)=>an,ln=o=>{if(ee!==Je)throw new Error("Attempted to overwrite existing lit-html security policy. setSanitizeDOMValueFactory should be called at most once.");ee=o},cn=()=>{ee=Je},Nt=(o,e,t)=>ee(o,e,t),It="$lit$",W=`lit$${String(Math.random()).slice(9)}$`,Ho="?"+W,dn=`<${Ho}>`,ue=document,_e=()=>ue.createComment(""),Se=o=>o===null||typeof o!="object"&&typeof o!="function",jo=Array.isArray,un=o=>jo(o)||typeof(o==null?void 0:o[Symbol.iterator])=="function",ft=`[ 	
\f\r]`,mn=`[^ 	
...
`,x=class extends te{constructor(){super(),this.expanded=!1,this.messages=[],this.notifications=[],this.frontendStatus="unavailable",this.javaStatus="unavailable",this.tabs=[{id:"log",title:"Log",render:this.renderLog,activate:this.activateLog},{id:"info",title:"Info",render:this.renderInfo},{id:"features",title:"Feature Flags",render:this.renderFeatures}],this.activeTab="log",this.serverInfo={flowVersion:"",vaadinVersion:"",javaVersion:"",osVersion:"",productName:""},this.features=[],this.unreadErrors=!1,this.componentPickActive=!1,this.nextMessageId=1,this.transitionDuration=0,window.Vaadin.Flow&&this.tabs.push({id:"code",title:"Code",render:this.renderCode})}static get styles(){return[b`
    ...
    `}render(){return R` <div
      ...
      <div>
        ...
        <button
          class="button pick"
          @click=${()=>{this.componentPickActive=!0,Be(()=>import("./component-picker-891907d1.js"),[],import.meta.url)}}
        >
 ...
 */const Xo=[];function Qo(o){return o&&Object.prototype.hasOwnProperty.call(o,"__themes")}function er(o){return Qo(customElements.get(o))}function tr(o=[]){return[o].flat(1/0).filter(e=>e instanceof zt?!0:(console.warn("An item in styles is not of type CSSResult. Use `unsafeCSS` or `css`."),!1))}function Qe(o,e,t={}){o&&er(o)&&console.warn(`The custom element definition for "${o}"
      ...
      importing the corresponding custom element.`),e=tr(e),window.Vaadin&&window.Vaadin.styleModules?window.Vaadin.styleModules.registerStyles(o,e,t):Xo.push({themeFor:o,styles:e,include:t.include,moduleId:t.moduleId})}function Lt(){return window.Vaadin&&window.Vaadin.styleModules?window.Vaadin.styleModules.getAllThemes():Xo}function or(o,e){return(o||"").split(" ").some(t=>new RegExp(`^${t.split("*").join(".*")}$`,"u").test(e))}function ir(o=""){let e=0;return o.startsWith("lumo-")||o.startsWith("material-")?e=1:o.startsWith("vaadin-")&&(e=2),e}function Zo(o){const e=[];return o.include&&[].concat(o.include).forEach(t=>{const i=Lt().find(n=>n.moduleId===t);i?e.push(...Zo(i),...i.styles):console.warn(`Included moduleId ${t} not found in style registry`)},o.styles),e}function nr(o,e){const t=document.createElement("style");t.innerHTML=o.map(i=>i.cssText).join(`
`),e.content.appendChild(t)}function rr(o){const e=`${o}-default-theme`,t=Lt().filter(i=>i.moduleId!==e&&or(i.themeFor,o)).map(i=>({...i,styles:[...Zo(i),...i.styles],includePriority:ir(i.moduleId)})).sort((i,n)=>n.includePriority-i.includePriority);return t.length>0?t:Lt().filter(i=>i.moduleId===e)}const Sr=o=>class extends Zn(o){static finalize(){if(super.finalize(),this.elementStyles)return;const t=this.prototype._template;!t||Qo(this)||nr(this.getStylesForThis(),t)}static finalizeStyles(t){const i=this.getStylesForThis();return t?[...super.finalizeStyles(t),...i]:i}static getStylesForThis(){const t=Object.getPrototypeOf(this.prototype),i=(t?t.constructor.__themes:[])||[];this.__themes=[...i,...rr(this.is)];const n=this.__themes.flatMap(r=>r.styles);return n.filter((r,s)=>s===n.lastIndexOf(r))}};/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const sr=b`
...
${gr}
${vr}
`;Qe("",li,{moduleId:"lumo-utility"});const ye=(o,e)=>{const t=document.createElement("style");t.type="text/css",t.appendChild(document.createTextNode(o)),e===document?document.head.appendChild(t):e.appendChild(t)};window.Vaadin=window.Vaadin||{};window.Vaadin.theme=window.Vaadin.theme||{};window.Vaadin.theme.injectedGlobalCss=[];const yr=o=>{document._vaadintheme_sapldemowebeditor_componentCss||(document._vaadintheme_sapldemowebeditor_componentCss=!0),ye(ei.cssText,o),ye(ii.cssText,o),ye(ni.cssText,o),ye(ai.cssText,o),ye(li.cssText,o)},br=yr;br(document);export{zn as D,te as L,Pn as P,Sr as T,Zn as a,Ue as b,b as c,Z as d,On as e,ii as f,Xo as g,R as h,_ as i,fe as j,S as n,Xn as p,Ln as q,Qe as r,wr as s,ei as t,tn as u};
