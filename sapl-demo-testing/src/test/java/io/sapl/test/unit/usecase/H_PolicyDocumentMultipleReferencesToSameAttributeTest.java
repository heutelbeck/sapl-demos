...
public class H_PolicyDocumentMultipleReferencesToSameAttributeTest {
	...
	void test_withFunctionSequenceMock() {
		...
		fixture.constructTestCaseWithMocks()
			...
			.givenFunctionOnce("time.secondOf", Val.of(1), Val.of(15), Val.of(25), Val.of(25), Val.of(35), Val.of(35), Val.of(45), Val.of(45), Val.of(45), Val.of(55), Val.of(55), Val.of(55))
