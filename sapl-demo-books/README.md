...
For the same security scenario using SAPL's built-in R2DBC query manipulation without a custom constraint handler, see the sapl-demo-spring-data-r2dbc project. For the MongoDB equivalent, see sapl-demo-spring-data-mongo-reactive.
