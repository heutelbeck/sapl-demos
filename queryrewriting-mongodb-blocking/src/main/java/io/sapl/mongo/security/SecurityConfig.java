...
public class SecurityConfig {
     ...
     * UserDetailsPasswordService, which causes password upgrade logic to convert our
     * custom UserDetails into a generic User object.
     */
    @Bean
     ...
     * <p>
     * After successful credential validation, the Authentication's principal is set to the
     * LibraryUser (identity object) rather than the LibraryUserDetails (auth wrapper). This
     * ensures no credentials leak into the authorization context.
     */
    @Bean
        ...
        return new AuthenticationProvider() {
            ...
            public Authentication authenticate(Authentication authentication) throws AuthenticationException {
                ...
                if (auth.getPrincipal() instanceof LibraryUserDetails details) {
                    return new UsernamePasswordAuthenticationToken(details.libraryUser(), null,
