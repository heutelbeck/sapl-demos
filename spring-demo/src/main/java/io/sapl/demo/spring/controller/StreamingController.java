...
class StreamingController {
    ...
    @GetMapping(value = "/api/streaming/heartbeat/till-denied", produces = MediaType.TEXT_EVENT_STREAM_VALUE)
    ...
    @GetMapping(value = "/api/streaming/heartbeat/silent-suspending", produces = MediaType.TEXT_EVENT_STREAM_VALUE)
    ...
    @GetMapping(value = "/api/streaming/heartbeat/observed-suspending", produces = MediaType.TEXT_EVENT_STREAM_VALUE)
    Flux<ServerSentEvent<Object>> heartbeatObservedSuspending() {
        return observedSuspendingSse();
    }

    // Service-layer streaming: enforcement is on StreamingService.heartbeatObservedSuspending().
    @GetMapping(value = "/api/services/streaming/heartbeat/observed-suspending", produces = MediaType.TEXT_EVENT_STREAM_VALUE)
    Flux<ServerSentEvent<Object>> serviceHeartbeatObservedSuspending() {
        return observedSuspendingSse();
    }
