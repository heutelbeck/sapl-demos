...
* In the sub-project https://github.com/heutelbeck/sapl-demos/blob/master/sapl-demo-obligation-advice[sapl-demo-obligation-advice] we show an approach to work with SAPL-obligations and -advices.
