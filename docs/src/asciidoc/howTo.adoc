...
* Build the project at the root level.

* Go to  submodules like sapl-demo-annotation, sapl-demo-filterchain, sapl-demo-permissionevaluator, sapl-demo-pip, sapl-demo-voter and start the application from the main class.
