...
public class UIController {
	...
	public String getPatients(HttpServletRequest request, Model model,
		...
		model.addAttribute("permittedToUseCreatePatientButton", isPermitted(
				authentication, "use", "ui:view:patients:createPatientButton"));
		return "patients";
	}
	...
	public String createPatient(@ModelAttribute(value = "newPatient") Patient patient) {
		if (patient.getId() != null) {
			throw new IllegalArgumentException(
					"Patient has a predefined id. Should be autogenerated.");
		}
	...
	public String getPatient(@PathVariable Long id, Model model,
		...
		model.addAttribute("patient", patient);
		model.addAttribute("permittedToUseUpdatePatientButton", isPermitted(
				authentication, "use", "ui:view:patient:updatePatientButton"));
		model.addAttribute("permittedToUseDeletePatientButton",
				isPermitted(authentication, "use", om.readTree("{ \"id\": " + id
						+ ", \"uiElement\": \"ui:view:patient:deletePatientButton\"}")));
